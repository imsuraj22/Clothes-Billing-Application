...
public class CustomerPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 280, 879, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/shop 2.jpg"))); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try
        {
            System.out.println("Entered iside try block");
            ResultSet rs=DbOperations.getCustomerShoppingDetails();
            System.out.println("Entered here");
            while(rs.next())
            {
                System.out.println("Entered inside while as well");
                 String cus_items=rs.getString("items");
                
                String[] cus_items_arr=cus_items.split(",");
                for(int i=0;i<cus_items_arr.length;i++){
                    System.out.println(cus_items_arr[i]+" ");
                }
